...
use foundation_finality_grandpa::{RoundNumber, SetId, GRANDPA_ENGINE_ID};
...
pub fn generate_equivocation_proof(
...
) -> foundation_finality_grandpa::EquivocationProof<H256, u64> {
	let signed_prevote = |round, hash, number, keyring: &Ed25519Keyring| {
		...
		let payload = foundation_finality_grandpa::localized_payload(round, set_id, &prevote_msg);
	...
	foundation_finality_grandpa::EquivocationProof::new(
		set_id,
		foundation_finality_grandpa::Equivocation::Prevote(finality_grandpa::Equivocation {
